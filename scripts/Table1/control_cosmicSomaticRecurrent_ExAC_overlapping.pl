...
open control, "ExAC_variants.txt";
...
open cosmic, "cosmicv73RecurrentSomatic.txt";
my %cosmic;
my $cosno = 0;
...
open output, ">Result_controlExAC_cosmicRecurrentSomatic_1000";
